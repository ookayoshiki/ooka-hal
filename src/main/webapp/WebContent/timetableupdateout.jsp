...
String time_ididStr =request.getParameter("time_idid");
...
String nullflagStr =request.getParameter("nullflag");
...
//SQL文の構築(DB更新)
SQL.append("update time_tbl set time_name= null, time_teacher= null, time_room= null, time_msg= null where user_no ='");
SQL.append(user_noStr);
SQL.append("' and time_id ='");
SQL.append(time_ididStr);
SQL.append("'");
...
<p><%if("1".equals(nullflagStr)){ %>登録<%}else{ %>変更<%} %>完了です！</p>
<div class="hoge">
