...
<form method="Post" id="com" action="todocompletion.jsp">
<input type="hidden"name="user_no"value="<%= user_noStr %>">
</form>
...
if("0".equals(list.get(i).get("todo_completion"))){
...
<form method="Post" id="delete1" action="tododeletein.jsp">
<input type="hidden"name="user_no"value="<%= user_noStr %>">
...
<input type="hidden"name="user_no"value="<%= user_noStr %>">
<input type="hidden"name="todo_id"value="<%=list.get(i).get("todo_id")%>">
<button class="buttonB"type="submit">完了</button>
</form></td>
<td>
...
<td><button class="buttonA" form="com" type="submit">完了済み一覧</button></td>
</div>
</table>
</div>
